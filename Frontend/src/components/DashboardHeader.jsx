...
const DashboardHeader = () => {
  ...
  return (
    <header className="shadow-xs border-b border-gray-100 bg-neutral-50 py-4 px-8">
        ...
        <div className="flex-1 max-w-lg mx-10">
          <div className="flex items-center border border-gray-100 rounded-lg bg-white shadow-xs">
            <input
              ...
              className="flex-1 outline-none text-sm text-gray-700 bg-transparent pl-3 text-[17px] placeholder:text-[17px]"
            />
